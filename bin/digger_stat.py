...
def execute(date_string, access_log, output_dir):
    try:
        ...
        saveResultAsFile(date_string,adDict,[showPvKey, showTokenKey, clickPvKey, clickTokenKey, installPvKey, installTokenKey, validClickPvKey, validClickTokenKey],"\t".join(["#pkg","lc","v","child" ,"entry","op","pid","tid","gid","id","showpv","showuv","clickpv","clickuv","installpv","installuv","validclickpv","validclickuv"]),"%s/adPv_%s.txt" %( output_dir,date_string))
        saveResultAsFile(date_string,groupDict,[showPvKey, showTokenKey, clickPvKey, clickTokenKey, installPvKey, installTokenKey, validClickPvKey, validClickTokenKey],"\t".join(["#pkg","lc","v","child" ,"op","pid","tid","gid","showpv","showuv","clickpv","clickuv","installpv","installuv","validclickpv","validclickuv"]),"%s/adGroupPv_%s.txt" %(output_dir,date_string))
        saveResultAsFile(date_string,projectDict,[showPvKey, showTokenKey, clickPvKey, clickTokenKey, installPvKey, installTokenKey, validClickPvKey, validClickTokenKey],"\t".join(["#pkg","lc","v","child" ,"op","pid","showpv","showuv","clickpv","clickuv","installpv","installuv","validclickpv","validclickuv"]),"%s/projectPv_%s.txt" %(output_dir,date_string))
        saveResultAsFile(date_string,productDict,[homevisitPvKey,homevisitTokenKey,boxshowPvKey, boxshowTokenKey, clickPvKey, clickTokenKey, installPvKey, installTokenKey, validClickPvKey, validClickTokenKey],"\t".join(["#pkg","lc","v","child" ,"licene","op","homevisitbpv","homevisituv","boxshowpv","boxshowuv","clickpv","clickuv","installpv","installuv","validclickpv","validclickuv"]),"%s/productPv_%s.txt" %(output_dir,date_string))
        saveResultAsFile(date_string,entryDict,[entryvisitPvKey,entryvisitTokenKey],"\t".join(["#pkg","lc","v","child" ,"entry","op","pid","tid","entryvisitpv","entryvisituv"]),"%s/entryPv_%s.txt" %(output_dir,date_string))
